...
from extrema_custom import find_extrema_custom
from bycycle.cyclepoints import find_zerox

###################################################################################################
###################################################################################################

def compute_cyclepoints_custom(sig, fs, f_range, **find_extrema_kwargs):
    ...
    peaks, troughs = find_extrema_custom(sig, fs, f_range, **find_extrema_kwargs)
